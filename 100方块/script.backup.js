...
(function (exp) {
    ...
    var initPages = {
        indexPage: function () {
            ...
            score1 = new Number("0");score1.x = 120; score1.y = 80;
            ...
            score2 = new Number("0", 1, 2); score2.x = 400; score2.y = 80;
            //score2.defaultlength = 3;
            score2.spacing = 4; score2.setNumber(parseInt(getParameterByName("MaxScore")));
    ...
    var gameCommon = {
        ...
        init: function () {
            ...
            eventBackLayer.addEventListener(LMouseEvent.MOUSE_UP, function (e) {
                ...
                if (!gameCommon.testState(activeBlock)) {
                    ...
                    score1.setNumber(_s + activeBlock.score);
                    activeBlock.remove();
            ...
            for (var i = 0, l = arr.length; i < l; i++) {
                (function (arg) {
                    ...
                    _shape.addEventListener(LMouseEvent.MOUSE_DOWN, function (e) {
                        ...
                        _self.state = 2;
                        activeBlock = _self;
                        LTweenLite.to(_self, 0.03, { scaleX: 1, scaleY: 1 });
        ...
        refreshMainPanel: function () {
            ...
            if (score_x.length != 0 || score_y.length != 0) {
                ...
                //alert(0);
                playSound("s_dropIn.wav", function () { this.play(0, 1); });
                backFn();
            }
        },
...
/*
var key = "{'MemberID':1001}";
alert(base64Coder.base64encode(key));
LAjax.get("http://112.74.86.15:803/api.aspx?method=GamesApi.GetMemberInfoForGame&params=" + base64Coder.base64encode(key), {}, function (data) {
    alert(data);
});
*/
//var params = { "MemberID": "1001", "Score": "500", "Type": "9", "ChallengeScore": getParameterByName("ChallengeScore") };//ChallengeScore挑战分数
//console.log(JSON.stringify(params));
//var paramsStr = base64Coder.base64encode(JSON.stringify(params));
//console.log(paramsStr);
//LAjax.get(ApiUrl + "/api.aspx?method=GamesApi.AddGameH5Record&params=" + paramsStr, {}, function (data) {
//    alert(data);
//});
//var key = "{ 'MemberID': '1001', 'Score': '500', 'Type': '9', 'ChallengeID': '52' }";
//var paramsStr = base64Coder.base64encode(key);
//LAjax.responseType = LAjax.JSON;
//LAjax.get("http://112.74.86.15:803/api.aspx?method=GamesApi.AddGameH5Record&params=" + paramsStr, {}, function (data) {
//    if (data.status == 0) {
//        alert(data.msg);
//    }
//});
